...
//             className="w-full max-w-md px-5 py-3 rounded-xl bg-slate-900 border border-slate-800 focus:outline-none focus:border-indigo-500"
//           />
//         </div>

//         {/* CTA */}
//         <button className="mt-6 px-6 py-3 bg-indigo-500 hover:bg-indigo-600 rounded-xl">
//           Shop Now
//         </button>
...
//                 <button className="mt-3 w-full bg-indigo-500 hover:bg-indigo-600 py-2 rounded-lg text-sm">
//                   Add to Cart
//                 </button>
...
//         <div className="bg-gradient-to-r from-indigo-600 to-cyan-500 rounded-2xl p-10 text-center">
...
//             Shop smarter with our next-gen e-commerce platform
//           </p>
...
//         © {new Date().getFullYear()} Modern E-Commerce
//       </footer>
